About pyscaffoldext-dsproject-feedstock
=======================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyscaffoldext-dsproject-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12156&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyscaffoldext-dsproject-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyscaffoldext-dsproject` can be installed with `conda`:
...
```
mamba install pyscaffoldext-dsproject
```

It is possible to list all of the versions of `pyscaffoldext-dsproject` available on your platform with `conda`:
...
```
mamba search pyscaffoldext-dsproject --channel conda-forge
```
...
mamba repoquery search pyscaffoldext-dsproject --channel conda-forge

# List packages depending on `pyscaffoldext-dsproject`:
mamba repoquery whoneeds pyscaffoldext-dsproject --channel conda-forge

# List dependencies of `pyscaffoldext-dsproject`:
mamba repoquery depends pyscaffoldext-dsproject --channel conda-forge
```
